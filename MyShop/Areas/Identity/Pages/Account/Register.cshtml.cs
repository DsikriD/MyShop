...
namespace MyShop.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {// RoleExistsAsync() - проверяет существует ли такая роль в базе данных 
            if (!await _roleManager.RoleExistsAsync(WC.AdminRole))// Для создания ролей в бд, когда они еще не созданы
            {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {// Текущий пользователь вошедший в систему имеет права администатора 
                        await _userManager.AddToRoleAsync(user, WC.AdminRole);// _Admin1A
                    }
                    else
                    {
